...
const TABLES = [
  `CREATE TABLE IF NOT EXISTS folders (id TEXT PRIMARY KEY, slug TEXT UNIQUE NOT NULL, title TEXT, description TEXT, command TEXT, webhook_url TEXT, token_hash TEXT, created_at TEXT DEFAULT (datetime('now')))`,
